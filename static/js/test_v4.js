requirejs(["utils"], function(utils) {
  ...
  var svg_three = d3.select("body").append("svg")
      .attr("width", width + margin.left + margin.right)
      .attr("height", height + margin.top + margin.bottom)
      //.style("margin-left", -margin.left + "px")
    .append("g");
  ...
  var treemap_nodes = treemap(root)
  ...
  console.log("treemap nodes:", treemap_nodes)
    ...
    .append("rect")
      ...
      /*.attr('width', function (d) { 
        console.log(d.dx,d.x)
        return d.dx - d.x; })
      .attr('height', function (d) { return d.y - d.dy; })*/
      .style("stroke", "black")
      .style("fill", "#69b3a2");
  ...
  d3.json("./files/hierarchical_v4.json", function(miserables) {
    ...
    //transform links to "source: index, target: other_index" format
    /*var graph = {
  nodes: d3.range(13).map(Object),
  links: [
    {source:  0, target:  1, value: "allocates"},
    {source:  1, target:  2, value: "allocates"},
    {source:  2, target:  0, value: "hasParent"},
    {source:  1, target:  3, value: "allocates"},
    {source:  3, target:  2, value: "isContainedBy"},
    {source:  3, target:  4, value: "allocates"},
    {source:  4, target:  5, value: "allocates"},
    {source:  5, target:  6, value: "hasParent"},
    {source:  5, target:  7, value: "allocates"},
    {source:  6, target:  7, value: "allocates"},
    {source:  6, target:  8, value: "allocates"},
    {source:  7, target:  8, value: "isContainedBy"},
    {source:  9, target:  4, value: "allocates"},
    {source:  9, target: 11, value: "allocates"},
    {source:  9, target: 10, value: "allocates"},
    {source: 10, target: 11, value: "allocates"},
    {source: 11, target: 12, value: "allocates"},
    {source: 12, target: 10, value: "allocates"}
  ]
};*/
...
var indexedLinks = getIndexedLinks(miserables.links, nodelist);
    ...
    var adj_matrix = get_adj_matrix(matrix);
